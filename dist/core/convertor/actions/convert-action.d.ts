...
export declare function executeScript<T>(scriptName: string, parameters: Record<string, any> | undefined, scripts: Script<T>[], external: Record<string, any>, convertorSet: ConvertorSet, processorHelper: ScriptProcessorHelper): Promise<() => void>;
