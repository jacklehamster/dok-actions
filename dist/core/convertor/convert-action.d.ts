...
export declare function convertAction<T>(action: T, stepResults: ExecutionStep[], utils: Utils<T>, external: Record<string, any> | undefined, actionConversionMap: ActionConvertorList): ConvertBehavior | undefined;
