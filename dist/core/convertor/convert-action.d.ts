...
export declare function convertAction<T>(action: T, stepResults: ExecutionStep[], getSteps: GetSteps, external: Record<string, any> | undefined, actionConversionMap: ActionConvertorList): ConvertBehavior | undefined;
